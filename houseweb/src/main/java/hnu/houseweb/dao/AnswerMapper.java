...
public interface AnswerMapper {
    ...
    @Select("select answer.*,user.name,user.img from answer,user,question where question.questionNo=answer.questionNo and answer.userId=user.userId and question.questionNo=#{questionNo,jdbcType=INTEGER} order by answerTime")
