...
public class UploadHouseServiceImpl implements UploadHouseService {
    ...
    private String basePath = "http://shihuan.site/houseweb/";
    ...
    private HouseDetail getHouseDetail(HttpServletRequest request){
        ...
        houseDetail.setCommunityNo(request.getParameter("communityNo"));
        ...
        houseDetail.setPropertyYear(request.getParameter("propertyYear"));
        /* 数值的统一处理, 事实上这些不能为空的 */
        try {
